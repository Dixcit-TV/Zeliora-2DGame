...
//-----------------------------------------------------------------
Rectp::Rectp()
	: Rectp(0.f, 0.f, 0.f, 0.f)
{}

Rectp::Rectp(float centerX, float centerY, float halfWidth, float halfHeight)
	: Rectp(Point2f{centerX, centerY}, halfWidth, halfHeight)
{}

Rectp::Rectp(const Point2f& center, float halfWidth, float halfHeight)
	: center{ center }
	, halfWidth{ halfWidth }
	, halfHeight{ halfHeight }
{}

bool Rectp::operator ==(const Rectp& other) const
{
	return center == other.center && halfWidth == other.halfWidth && halfHeight == other.halfHeight;
}
